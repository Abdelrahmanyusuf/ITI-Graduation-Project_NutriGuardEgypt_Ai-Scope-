...
| BUG-03 “without ingredient” | The named ingredient is removed from a cloned recipe and nutrition is recalculated. | An unresolved ingredient produces an explicit failure; the original recipe is never presented as modified. |
