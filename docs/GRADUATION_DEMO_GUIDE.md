...
نسخة المناقشة تعمل محليًا دون مفاتيح خارجية. تحتوي قاعدة العرض على 215 وصفة مصرية مرشحة، و169 مرجعًا غذائيًا للمكونات، و218 وثيقة مفهرسة للاسترجاع. تبقى القيم تقديرية وحالة البيانات `needs_review` حتى لا نخلط بين Demo أكاديمي واعتماد صحي إنتاجي.
