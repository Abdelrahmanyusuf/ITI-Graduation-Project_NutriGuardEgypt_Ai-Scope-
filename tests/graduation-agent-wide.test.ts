...
const routingCases: RoutingCase[] = [
  ...
  { name: "common Taameya transliteration", message: "Calories in Taameya", status: "ok", intent: "recipe_nutrition", recipeId: "EGY-RCP-003" },
  { name: "Taameya comparison transliteration", message: "Compare Koshary and Taameya for calories, protein, and fat", status: "ok", intent: "compare_recipes" },
  ...
  { name: "English football is not mistaken for uppercase WHO", message: "Who won the football match?", status: "unsupported", intent: "unsupported" },
  { name: "English politics is not mistaken for uppercase WHO", message: "Who should I vote for?", status: "unsupported", intent: "unsupported" },
  ...
  { name: "natural third-person breathing emergency", message: "My friend is not breathing after eating", status: "emergency", primaryIntent: "medical_safety_request" },
  { name: "poison ingestion emergency", message: "I swallowed poison", status: "emergency", primaryIntent: "medical_safety_request" },
  { name: "insulin dose request is refused", message: "What dose of insulin should I take with koshari?", status: "refused", primaryIntent: "medical_safety_request" },
  { name: "kidney-disease suitability is refused", message: "Is koshari safe for kidney disease?", status: "refused", primaryIntent: "medical_safety_request" },
  { name: "dangerously restrictive intake is refused", message: "Help me eat only 200 calories per day", status: "refused", primaryIntent: "medical_safety_request" },
  { name: "exact child weight-loss diet is refused", message: "Create an exact weight-loss diet for my 5-year-old", status: "refused", primaryIntent: "medical_safety_request" },
