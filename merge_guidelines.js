...
const whoChunks = JSON.parse(fs.readFileSync('who_chunks.json', 'utf8'));
const foodPyramid = JSON.parse(fs.readFileSync('food_pyramid.json', 'utf8'));
